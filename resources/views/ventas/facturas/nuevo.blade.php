            ...
            <div class="card">
                <div class="card-header">
                    <div class="btn-group" role="group" aria-label="Basic example" id="">
                        <a href="{{ route('nuevaFactura') }}" class="btn btn-unique" style="color:white">
                            <i class="fas fa-cart-plus fa-2x" style="color:white"></i> NUEVA VENTA
                        </a>
                        <button class="btn btn-elegant" data-toggle="modal" data-target="#modalListadoClientes" style="color:white">
